  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-df-bg">
      ...
      <div className="df-container relative z-20">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center min-h-screen py-20">
          ...
          <div className="text-center lg:text-left space-y-8 animate-fade-in">
            ...
            <h1 className="df-heading df-h1 df-crown-glow leading-tight">
              {title}
            </h1>
            
            <p className="df-body-lg text-df-white/90 max-w-xl mx-auto lg:mx-0">
              {subtitle}
            </p>
            ...
            {/* Stats */}
            <div className="grid grid-cols-4 gap-4 mt-12 max-w-lg mx-auto lg:mx-0">
      ...
      <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
        <div className="text-df-gold/60 text-center animate-bounce">
